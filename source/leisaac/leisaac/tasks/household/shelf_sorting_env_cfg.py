...
@configclass
class ShelfSortingSceneCfg(SingleArmTaskSceneCfg):
...
@configclass
class ShelfSortingObservationsCfg(SingleArmObservationsCfg):
...
@configclass
class ShelfSortingTerminationsCfg(SingleArmTerminationsCfg):
...
@configclass
class ShelfSortingEnvCfg(SingleArmTaskEnvCfg):
