...
@configclass
class BreakfastSetupSceneCfg(SingleArmTaskSceneCfg):
...
@configclass
class BreakfastSetupObservationsCfg(SingleArmObservationsCfg):
...
@configclass
class BreakfastSetupTerminationsCfg(SingleArmTerminationsCfg):
...
@configclass
class BreakfastSetupEnvCfg(SingleArmTaskEnvCfg):
