...
@configclass
class MicrowaveMealPrepSceneCfg(SingleArmTaskSceneCfg):
...
@configclass
class MicrowaveMealPrepObservationsCfg(SingleArmObservationsCfg):
...
@configclass
class MicrowaveMealPrepTerminationsCfg(SingleArmTerminationsCfg):
...
@configclass
class MicrowaveMealPrepEnvCfg(SingleArmTaskEnvCfg):
