...
@configclass
class UtensilStationSceneCfg(XLeRobotTaskSceneCfg):
...
@configclass
class UtensilStationEnvCfg(XLeRobotTaskEnvCfg):
    ...
    def __post_init__(self) -> None:
        ...
        domain_randomization(
            ...
            random_options=[
                randomize_objects_permutation(
                    ["utensil_plate", "oil_bottle", "prep_fruit", "knife_block", "prep_pot"],
                    position_noise=0.07,
                    scene_cfg=self.scene,
                    reference_name="utensil_table",
                ),
                randomize_camera_uniform(
                    "top",
                    pose_range={
