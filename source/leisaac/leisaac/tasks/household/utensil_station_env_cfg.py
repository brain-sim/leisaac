...
@configclass
class UtensilStationSceneCfg(SingleArmTaskSceneCfg):
...
@configclass
class UtensilStationObservationsCfg(SingleArmObservationsCfg):
...
@configclass
class UtensilStationTerminationsCfg(SingleArmTerminationsCfg):
...
@configclass
class UtensilStationEnvCfg(SingleArmTaskEnvCfg):
