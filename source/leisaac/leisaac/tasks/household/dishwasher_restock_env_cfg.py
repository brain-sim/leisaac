...
@configclass
class DishwasherRestockSceneCfg(SingleArmTaskSceneCfg):
...
@configclass
class DishwasherRestockObservationsCfg(SingleArmObservationsCfg):
...
@configclass
class DishwasherRestockTerminationsCfg(SingleArmTerminationsCfg):
...
@configclass
class DishwasherRestockEnvCfg(SingleArmTaskEnvCfg):
