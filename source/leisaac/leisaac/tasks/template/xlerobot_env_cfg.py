...
class XLeRobotTaskSceneCfg(InteractiveSceneCfg):
    ...
    right_ee_frame: FrameTransformerCfg = FrameTransformerCfg(
        ...
        target_frames=[
            FrameTransformerCfg.FrameCfg(
                prim_path="{ENV_REGEX_NS}/XLeRobot/so101_follower_r/gripper",
                name="right_gripper",
    ...
    left_ee_frame: FrameTransformerCfg = FrameTransformerCfg(
        ...
        target_frames=[
            FrameTransformerCfg.FrameCfg(
                prim_path="{ENV_REGEX_NS}/XLeRobot/so101_follower_l/gripper",
                name="left_gripper",
                offset=OffsetCfg(pos=(0.0, 0.0, 0.0)),
            ),
        ],
    ...
    left_wrist: TiledCameraCfg = TiledCameraCfg(
        prim_path="{ENV_REGEX_NS}/XLeRobot/so101_follower_l/gripper/left_wrist_camera",
        # offset=TiledCameraCfg.OffsetCfg(
        #     pos=(0.0, 0.0, 0.0), rot=(0.7071, 0.0, -0.7071, 0.0), convention="opengl"
        # ),
        offset=TiledCameraCfg.OffsetCfg(
            pos=(-0.001, 0.1, -0.04),
    ...
    right_wrist: TiledCameraCfg = TiledCameraCfg(
        prim_path="{ENV_REGEX_NS}/XLeRobot/so101_follower_r/gripper/right_wrist_camera",
        # offset=TiledCameraCfg.OffsetCfg(
        #     pos=(0.0, 0.0, 0.0), rot=(0.7071, 0.0, -0.7071, 0.0), convention="opengl"
        # ),
        offset=TiledCameraCfg.OffsetCfg(
    ...
    top: TiledCameraCfg = TiledCameraCfg(
        prim_path="{ENV_REGEX_NS}/XLeRobot/head_tilt_link/head_camera_link/top_camera",
        offset=TiledCameraCfg.OffsetCfg(
            pos=(0.0, 0.0, 0.0),
...
class XLeRobotObservationsCfg:
    ...
    class PolicyCfg(ObsGroup):
        ...
        base_root_pos = ObsTerm(
            func=mdp.root_pos_w, params={"asset_cfg": SceneEntityCfg("robot")}
        )
        base_root_quat = ObsTerm(
            func=mdp.root_quat_w, params={"asset_cfg": SceneEntityCfg("robot")}
        )
        base_root_lin_vel = ObsTerm(
            func=mdp.root_lin_vel_w, params={"asset_cfg": SceneEntityCfg("robot")}
        )
        base_root_ang_vel = ObsTerm(
            func=mdp.root_ang_vel_w, params={"asset_cfg": SceneEntityCfg("robot")}
        )
        ...
        left_rgb = ObsTerm(
            func=mdp.image,
            params={
                "sensor_cfg": SceneEntityCfg("left_wrist"),
                "data_type": "rgb",
                "normalize": False,
            },
        )
        right_rgb = ObsTerm(
            func=mdp.image,
            params={
                "sensor_cfg": SceneEntityCfg("right_wrist"),
                "data_type": "rgb",
                "normalize": False,
            },
        )
